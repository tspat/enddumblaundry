  ...
  <Background color="bg-gray-100">
    <Section>
      <CenteredFooter
        ...
        iconList={
          <>
            ...
            <Link href="https://twitter.com/tumblelaundry">
              <a>
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href="https://www.youtube.com/channel/UCBPMDr6jEb4zp7akRJ9MGTg">
              <a>
            ...
            <Link href="https://www.linkedin.com/company/tumblelaundry/">
              <a>
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        ...
        <li>
          <Link href="https://tumble.to/welcome.html">
            <a>About</a>
          </Link>
        </li>
        <li>
