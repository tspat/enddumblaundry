        ...
        <div className="w-10/12 ml-auto mr-auto">
          ...
          <div className="my-16">
            ...
            <h3 className="mt-4 text-lg text-center text-tmbl-drk xl:text-2xl sm:text-xl lg:text-left ">
              ...
              is $2.75. The proposed price per dry is $2.00.</b> These prices are
