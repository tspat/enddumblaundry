...
export declare type RawMessengerAttributes = {
...
export declare type MessengerAttributes = {
...
export declare type RawDataAttributesCompany = {
    company_id: string;
    name?: string;
    created_at?: string;
    plan?: string;
...
export declare type DataAttributesCompany = {
...
export declare type RawDataAttributesAvatar = {
    type: string;
    image_url?: string;
};
export declare type DataAttributesAvatar = {
    /** The value is "avatar" */
    type: string;
    /** An avatar image URL
     *
...
export declare type RawDataAttributes = {
    email?: string;
    user_id?: string;
    created_at?: string;
    name?: string;
...
export declare type IntercomMethod = 'boot' | 'shutdown' | 'update' | 'hide' | 'show' | 'showMessages' | 'showNewMessage' | 'onHide' | 'onShow' | 'onUnreadCountChange' | 'trackEvent' | 'getVisitorId' | 'startTour';
export declare type RawIntercomProps = RawMessengerAttributes & RawDataAttributes;
export declare type RawIntercomBootProps = {
    app_id: string;
    api_base?: string;
} & RawIntercomProps;
export declare type IntercomProps = MessengerAttributes & DataAttributes;
export declare type IntercomBootProps = {
    /** The app ID of your Intercom app which will indicate where to store any data  */
    appId: string;
} & IntercomProps;
export declare type LogLevel = 'info' | 'error' | 'warn';
export declare type IntercomContextValues = {
    /**
...
export declare type IntercomProviderProps = {
    /** The app ID of your Intercom app which will indicate where to store any data  */
    appId: string;
    /**
